...
define dso_local noundef double @_Z7computed(double noundef %0) local_unnamed_addr #4 {
...
46:                                               ; preds = %42
  ...
  %48 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str.1, i64 noundef 29)
  %49 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIdEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, double noundef 0.000000e+00)
...
58:                                               ; preds = %46
  ...
  %60 = load i8, ptr %59, align 8, !tbaa !22
  %61 = icmp eq i8 %60, 0
...
65:                                               ; preds = %58
  ...
  %69 = call noundef signext i8 %68(ptr noundef nonnull align 8 dereferenceable(570) %55, i8 noundef signext 10)
  br label %70

70:                                               ; preds = %65, %62
  %71 = phi i8 [ %64, %62 ], [ %69, %65 ]
  %72 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %49, i8 noundef signext %71)
...
; Function Attrs: inaccessiblemem_or_argmemonly mustprogress nofree norecurse nosync nounwind willreturn
...
attributes #6 = { inaccessiblemem_or_argmemonly mustprogress nofree norecurse nosync nounwind willreturn "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
