...
@.str.2 = private unnamed_addr constant [11 x i8] c", dsquare(\00", align 1
...
define dso_local noundef double @_Z6squared(double noundef %0) #4 {
...
define dso_local noundef double @_Z7dsquared(double noundef %0) #5 {
  %2 = alloca double, align 8
  store double %0, ptr %2, align 8
  %3 = load double, ptr %2, align 8
  %4 = call { double } @diffe_Z6squared(double %3, double 1.000000e+00)
  %5 = extractvalue { double } %4, 0
  ret double %5
}

declare double @__enzyme_autodiff(ptr noundef, double noundef) #1
...
3:                                                ; preds = %22, %0
  %4 = load double, ptr %2, align 8
  %5 = fcmp olt double %4, 5.000000e+00
...
6:                                                ; preds = %3
  ...
  %12 = call noundef double @_Z6squared(double noundef %11)
  ...
  %19 = call noundef double @_Z7dsquared(double noundef %18)
...
define internal { double } @diffe_Z6squared(double noundef %0, double %differeturn) #7 {
...
invert:                                           ; preds = %1
  ...
  store double 0.000000e+00, ptr %"'de", align 8
  %3 = fmul fast double %2, %0
  %4 = load double, ptr %"'de1", align 8
  %5 = fadd fast double %4, %3
  store double %5, ptr %"'de1", align 8
  %6 = fmul fast double %2, %0
  %7 = load double, ptr %"'de1", align 8
  %8 = fadd fast double %7, %6
  store double %8, ptr %"'de1", align 8
  %9 = load double, ptr %"'de1", align 8
...
attributes #7 = { mustprogress noinline nounwind willreturn uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
